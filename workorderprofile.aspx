<%@ Page Language="C#" AutoEventWireup="true" CodeFile="workorderprofile.aspx.cs" Inherits="workorderprofile" %>
 ...
 <%--   </form>--%>
          ...
          <div id="divPhoto" style="display:none">
            ...
            <div class="form-group" style="margin-top:5px">
                    ...
                    <asp:Button ID="btnNewjoblog" runat="server" OnClick="btnNewjoblog_Click" class="btn btn-danger" Text="Edit Workorder" />
                    <asp:Button ID="btnActivityLog" runat="server"  class="btn btn-info" Text="View Activity Log" />
