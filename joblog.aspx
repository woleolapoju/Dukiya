<%@ Page Language="C#" AutoEventWireup="true" CodeFile="joblog.aspx.cs" Inherits="joblog" %>
...
<body onload="RemoveGridBlankRow()">
    ...
    function RemoveGridBlankRow()
    {
        ...
        rowscount = gridView.rows.length-1;
        //Reference the TBODY tag.
        var tbody = gridView.getElementsByTagName("tbody")[0];

        var row = tbody.getElementsByTagName("tr")[rowscount];
        tbody.removeChild(row);

        myRange.value = document.getElementById("hiddenCurrentLevel").value;

        var slider = document.getElementById("myRange");
        var output = document.getElementById("demo");
        output.innerHTML = document.getElementById("hiddenCurrentLevel").value + "% completed";
        y.value = slider.value;
				...
				<div class="w3layouts_main_grid" >
                    <table>
                        <tr >
                            ...
                            <td ><h1 class="w3layouts_head">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Activity Log</h1> 
                            </td>
                        </tr>
...
<form  runat="server" class="w3_form_post" style="margin-right:0px">
                            ...
                            <div class="w3_agileits_main_grid w3l_main_grid">
							        <span class="agileits_grid">
                                       ...
                                       <input type="text"  id="dProperty" runat="server" style="padding:1px" readonly="readonly" />
							        </span>
						        </div>
                                <div class="w3_agileits_main_grid w3l_main_grid" id="divContract_Details"  runat="server">
							        <span class="agileits_grid">
								        <label style="font-size:12px">Contract Details:</label>
                                       <input type="text"  id="Contract_Details" runat="server" style="padding:1px" readonly="readonly"/>
							        </span>
						        </div>

                              <div class="w3_agileits_main_grid w3l_main_grid">
							        <span class="agileits_grid">
								        <label style="font-size:12px">Job Description<span class="star">*</span></label>
                                        <textarea name="Task" id="tDetails" runat="server" style="margin-right:0px;padding:2px" placeholder="Please describe the Job/Action taken..." rows="8" required="required" autofocus="autofocus"></textarea>
							        </span>
						        </div>   
                               <div class="w3_agileits_main_grid w3l_main_grid">
							        <span class="agileits_grid">
								        <label style="font-size:12px">Job/Repair By:<span class="star">*</span></label>
                                        <textarea name="Task" id="JobTeam" runat="server" style="margin-right:0px;padding:2px" placeholder="Enter Job execution team" rows="2" required="required" autofocus="autofocus"></textarea>
							        </span>
						        </div>   
                                <div class="w3_agileits_main_grid w3l_main_grid">
							        <span class="agileits_grid">
								        <label style="font-size:12px">Client Update </label>
                                        <textarea name="Task" id="tClientUpdate" runat="server" style="margin-right:0px;padding:2px" placeholder="Enter infor. to update client with..." rows="2"  autofocus="autofocus"></textarea>
							        </span>
						        </div>
                                <div class="w3_agileits_main_grid w3l_main_grid">
							        <span class="agileits_grid">
								        <label style="font-size:12px">Cost of Job:</label>
                                       <input type="text"  id="costofjob" runat="server"  value="0" style="padding:2px;width:150px"  autocomplete="off" onkeypress="return isDecimal(event)"/>
							        </span>
						        </div>
                                    <div class="w3_agileits_main_grid w3l_main_grid">
							        <span class="agileits_grid">
								        <label style="font-size:12px">Cost of Supply:</label>
                                       <input type="text"  id="costofsupply" runat="server" value="0" style="padding:2px;width:150px" autocomplete="off" onkeypress="return isDecimal(event)" />
							        </span>
						        </div>
                                ...
                                <div class="w3_agileits_main_grid w3l_main_grid">
							        <span class="agileits_grid">
								        <label style="font-size:12px">Job Scope</label>
                                            </span>
                                    <div style="line-height:0.5px">
                                              <asp:RadioButtonList id="RadioScopeList" runat="server"  >
                                            <asp:ListItem value="In Compound" Selected="True" Text="In Compound" />
                                            <asp:ListItem value="Entire Estate" Text="Entire Estate"/>
                                            </asp:RadioButtonList>
                                    </div>
                                ...
                                <div class="w3_agileits_main_grid w3l_main_grid">
							        <span class="agileits_grid">
								        <label style="font-size:12px">Completion Level</label>
                                       <input type="range" min="1" max="100" value="50" class="slider" id="myRange"  >
                                         <input type="text"  id="hiddenRangeMonitor"  hidden="hidden"  runat="server" value="50" />
                                         <input type="text"  id="hiddenCurrentLevel"  hidden="hidden"  runat="server" value="0" />
                                        <span id="demo"></span>
							        </span>
						        </div>   

      <div class="w3_agileits_main_grid w3l_main_grid" id="completiondate" style="display:none;background-color:lightgray">
							        <span class="agileits_grid">
								        <label style="font-size:12px">Workorder Date Closed</label>
                                       <input type="text"  id="DateClosed_datepicker" runat="server" required="required" style="width:150px" autocomplete="off" readonly="" />
                                ...
                                <script>
                                    var slider = document.getElementById("myRange");
                                    var output = document.getElementById("demo");
                                    var x = document.getElementById("completiondate");
                                    var y = document.getElementById("hiddenRangeMonitor");
                                    output.innerHTML = slider.value + "% completed";
                                    y.value = slider.value;
                                    if (slider.value < 50) {
                                        output.style.color = "red";
                                    }
                                    ...
                                    slider.oninput = function () {
                                       ...
                                       y.value = this.value;
                                        ...
                                        if (output.innerHTML == "100% completed") {
                                            x.style.display = "block";
                                        }
                                        else { x.style.display = "none"; }
    ...
    function isDecimal(evt)
    {
      ...
      <script>
              $( function() {
                  ...
                  $("#DateClosed_datepicker").datepicker({
                      dateFormat: "dd-MM-yy",
                      autoSize: true,
                      currentText: "Now",
                      changeYear: true
              ...
              $(document).ready(function () {
                  ...
                  $('#end_datepicker').change(function () {
                      var start = $('#DateClosed_datepicker').datepicker('getDate');
                      ...
                      if (start <= end) {
                          ...
                          $('#end_datepicker').val($('#DateClosed_datepicker').datepicker('getDate'));
                          //$('#days').val("");
    ...
    <div style="overflow-x:auto;width:auto">
         <label style="font-size:15px;color:crimson">Expected Workorder Labour Specification</label>
                                ...
                                <td>
                                        <div class="w3_main_grid_right" style="text-align:left">
			                             <div  style="width:100px;background-color:black;color:white">
                                              <a  href="workorderlistings.aspx"><span style="color:white;text-align:center">  Go back  </span></a>
                                        </div>
						                </div>
                                    </td>
                                 <td>
		...
		<!-- //Calendar -->
              ...
              <script>
                  function goBack() {
                      ...
                      //window.history.back();
                      window.location.href = "workorderlistings.aspx";
                    }
              </script>
