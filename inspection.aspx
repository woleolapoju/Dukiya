				...
				<div class="w3layouts_main_grid" >
                    <table>
                        <tr >
                            ...
                            <td ><h1 class="w3layouts_head">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Inspection</h1> 
                            </td>
                        </tr>
...
<form  runat="server" class="w3_form_post" style="margin-right:0px">
                            ...
                            <div class="w3_agileits_main_grid w3l_main_grid">
                                ...
                                <div class="w3_agileits_main_grid w3l_main_grid">
							        <span class="agileits_grid">
								        <label style="font-size:12px">Property Unitname </label>
                        ...
                        <div id="divComplaintRef" runat="server" class="w3_agileits_main_grid w3l_main_grid" style="margin-top:0px;padding-top:0px">
							        <span class="agileits_grid">
                                          <label style="font-size:12px">Complaint RefNo: </label> <label style="width:auto;font-size:14px;font-weight:700;color:red" id="complaint_Ref" runat="server">??</label> <br />
                   ...
                   <br />
                                ...
                                <div class="w3_agileits_main_grid w3l_main_grid">
							        <span class="agileits_grid">
								        <label style="font-size:12px">Initial Action Taken </label>
                                        <textarea name="Task" id="tAction" runat="server" style="margin-right:0px" placeholder="Pls, describe initial action taken..." rows="3"  autofocus="autofocus"></textarea>
							        </span>
						        </div>
						        ...
						        <div class="w3_agileits_main_grid w3l_main_grid">
							        <span class="agileits_grid">
								        <label style="font-size:12px">Details <span class="star">*</span></label>
                                        <textarea name="Task" id="tDetails" runat="server" style="margin-right:0px" placeholder="Please enter details of inspection..." rows="6" required="required" autofocus="autofocus"></textarea>
							        </span>
						        </div>
                                ...
                                <div class="w3_agileits_main_grid w3l_main_grid">
							        <span class="agileits_grid">
                                        ...
                                        <textarea name="Task" id="tClientUpdate" runat="server" style="margin-right:0px" placeholder="Enter infor. to update client with..." rows="2"  autofocus="autofocus"></textarea>
							        </span>
						        </div>
                                 <div class="w3_agileits_main_grid w3l_main_grid">
							        <span class="agileits_grid">
                                 ...
                                 <div class="w3_agileits_main_grid w3l_main_grid">
							        <span class="agileits_grid">
								        <label style="font-size:12px">Inspection Team <span class="star">*</span></label>
                                       <input type="text"  id="inspectionteam" runat="server"/>
							        </span>
						        </div>
						        <div class="w3_agileits_main_grid w3l_main_grid">
							        <span class="agileits_grid">
                                ...
                                <td>
                                        <div class="w3_main_grid_right" style="text-align:left">
			                             <div  style="width:100px;background-color:black;color:white">
                                              <a  href="complaintlistforinspection.aspx"><span style="color:white;text-align:center">  Go back  </span></a>
                                        </div>
						                </div>
                                    </td>
		...
		<!-- //Calendar -->
              ...
              <script>
                  function goBack() {
                      ...
                      //window.history.back();
                      window.location.href = "complaintlistforinspection.aspx";
                    }
              </script>
